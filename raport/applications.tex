\section{Zastosowania spaceru losowego}\label{sec:applications}
...
\end{cases}
$$
Porównanie powyższych wyników analitycznych z symulacją przedstawia \autoref{fig:gamblers-ruin}.
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{gamblers_ruin.pdf}
    \caption{Prawdopodobieństwo ruiny gracza w zależności od kapitału początkowego z $N=50$.}
